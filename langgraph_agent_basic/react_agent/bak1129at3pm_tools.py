...
class MockChatModel:
    ...
    def invoke(self, messages, config=None):
        ...
        # Simple rule-based replies useful for testing.
        if "weather" in lower and ("sf" in lower or "san francisco" in lower):
            reply = "It's sunny in San Francisco, but you better look out if you're a Gemini."
        elif "fact about space" in lower or "space" in lower:
